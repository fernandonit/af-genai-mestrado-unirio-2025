# af-genai-mestrado-unirio-2025

Este repositório conta com os artefatos gerados por ocasião da minha dissertação para defesa do mestrado em informática pela Uni-Rio intitulada "EXPERIÊNCIA HUMANA COM INTERFACES DE LLM: UM ESTUDO COMPARATIVO BASEADO EM EIXOS DE AVALIAÇÃO".

A seguir, a lista dos artefatos e suas descrições.
